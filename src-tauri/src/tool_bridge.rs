    ...
    async fn execute(
        ...
        match tool_name {
                ...
                let matches: Vec<serde_json::Value> = entries
                    ...
                    .filter(|e| {
                        e.keyword
                            ...
                            || keyword
                                .to_lowercase()
                                .contains(&e.keyword.to_lowercase())
                    })
                    .map(|e| {
                        serde_json::json!({"keyword": e.keyword, "content": e.content})
                    })
                    .collect();
            ...
            "query_project_brain" => {
                ...
                crate::brain_service::answer_query(
                    &self.app,
                    &settings,
                    query,
                    |content| {
            ...
            "generate_bounded_continuation" => {
                ...
                let result = crate::llm_runtime::chat_text(
                    &settings, messages, false, 120,
                )
                .await
            ...
            "generate_chapter_draft" => {
                Err("generate_chapter_draft requires explicit approval."
                    .into())
            }
            ...
            | "record_run_trace" => {
                Ok(serde_json::json!({"status": "ok", "tool": tool_name}))
            }
