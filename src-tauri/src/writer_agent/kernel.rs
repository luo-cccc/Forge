...
use agent_harness_core::{
    default_writing_tool_registry, AgentLoop, AgentLoopConfig, EffectiveToolInventory, TaskBelief,
    TaskPacket, ToolHandler,
};
...
use super::memory::{
    ...
    ManualAgentTurnSummary, PromiseKind, StoryContractQuality, WriterMemory,
};
