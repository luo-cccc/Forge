...
- P2.2 memory-write gates now cover Canon / Promise proposal creation and foundation quality guards; the remaining memory quality gaps are safer same-entity attribute merges and richer Style memory validation.
